                      ...
                      <Col md={2}>
                        {
                          ...
                          <div>
                            <Link to={`/tags/${id}/${(parseInt(page) -1)}`}><img  className='selection__content__pages__icon' src="/images/icons/previous.svg" alt="" /></Link>
                      ...
                      <Col md={2}>
                        {
                          ...
                          <div>
                            ...
                            <Link to={`/tags/${id}/${(parseInt(page) +1)}`}><img className='selection__content__pages__icon next' src="/images/icons/previous.svg" alt="" /></Link>
                          </div>
                          :null
                        }
                      </Col>
