                    ...
                    <Col md={2} xs={3}>
                      {
                        ...
                        <div>
                          <Link onClick={()=> setMenu(false)}  to={`/categorias/${id}/${(parseInt(page) -1)}`}><img  className='selection__content__pages__icon' src="/images/icons/seta-esquerda.svg" alt="" /></Link>
                    ...
                    <Col md={2} xs={3}>
                      {
                        ...
                        <div>
                          ...
                          <Link onClick={()=> setMenu(false)} to={`/categorias/${id}/${(parseInt(page) +1)}`}><img className='selection__content__pages__icon next' src="/images/icons/seta-esquerda.svg" alt="" /></Link>
                        </div>
                        :null
                      }
                    </Col>
